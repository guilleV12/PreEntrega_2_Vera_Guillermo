...
const ItemDetail = ({ juego, closeDetailContainer }) => {
  return (
    <>
          <button className="close-detail-container" onClick={()=>{closeDetailContainer()}}><img src={X} className='img-close-detail' /></button>
          ...
          <h1 className="detail-categoria"><span className='pre-detail-graph'>Categoria: </span>{juego.categoria}.</h1>
